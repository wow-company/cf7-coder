...
add_action( 'wpcf7_init', 'wpcf7_add_form_tag_button', 10, 0 );

function wpcf7_add_form_tag_button() {
	wpcf7_add_form_tag( 'button', 'wpcf7_button_form_tag_handler' );
}

function wpcf7_button_form_tag_handler( $tag ) {
...
add_action( 'wpcf7_admin_init', 'wpcf7_add_tag_generator_button', 65, 0 );
...
function wpcf7_tag_generator_button( $contact_form, $args = '' ) {
	...
	$description = __( "Generate a form-tag for a button button. For more details, see %s.", 'contact-form-7' );
